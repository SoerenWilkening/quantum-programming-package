...
hypothesis: CONFIRMED — __getitem__ uses raw index into 64-element array instead of right-aligned offset
test: static code trace of x[0].branch(0.5) on 3-qubit qint
expecting: Ry gate targets garbage qubit index, not actual LSB
