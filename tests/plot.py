...
#
#
# amaz = pd.read_csv("amazon-bracket/amazon.csv")
# qisk = pd.read_csv("qiskit/qiskit.csv")
# cirq = pd.read_csv("circ/circ.csv")
# cq = pd.read_csv("cq/CQ.csv")
# cq_impr = pd.read_csv("cq/CQ_impr.csv")
# qs = pd.read_csv("QuantumProject/qsharp_qft_times.csv")
# quipper = pd.read_csv("quipper/quipper_qft_times.csv")
# ket = pd.read_csv("ket/ket_qft.csv")
# penny = pd.read_csv("pennylane/penny_qft.csv")
# pytket = pd.read_csv("pytket/pytket_qft.csv")
# aria = pd.read_csv("AriaQuanta/aria_qft.csv")
# projectq = pd.read_csv("projectQ/project_qft.csv")
#
# # cq_inpr = pd.read_csv("CQ_inprov_qtf.csv")
#
# fontsize = 12. / 0.8
# every = 1
# size = 5
...
# line3, = ax.plot(cq["n"], cq["t"], ".--", label="CQ", color=colors[4], marker = markers[0], markevery=every, markersize=size, markeredgewidth=width, linewidth=linewidth)
...
# plt.plot(cq_impr["n"], cq_impr["t"], ".--", label="CQ improved", color=colors[6], marker = markers[0], markevery=every, markersize=size, markeredgewidth=width, linewidth=linewidth)
...
# # plt.title("QFT circuit generation", fontsize = fontsize)
...
# plt.plot(qisk["n"], qisk["m"], ".--", label="Qiskit", color=colors[1], marker = markers[2], markevery=every, markersize=size, markeredgewidth=width, linewidth=linewidth)
...
# plt.xlabel('Qubits', fontsize=fontsize)
# # plt.legend(ncol=2, fontsize=fontsize)
# # plt.title("QFT circuit generation")
# plt.tight_layout(pad = 0.2)
